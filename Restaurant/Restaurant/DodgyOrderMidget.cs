namespace Restaurant
{
    ...
    public class DodgyOrderMidget : IMidget
    {
        private readonly IDispatcher dispatcher;
        private bool foodCooked;
        public Guid CorrelationId { get; private set; }

        public DodgyOrderMidget(Guid correlationId, IDispatcher dispatcher)
        {
        ...
        public void Handle(FirstCookRetry @event)
        {
            ...
            Console.ResetColor();
            dispatcher.Publish(new SendToMeIn(CorrelationId, DateTime.Now.AddSeconds(6), new SecondCookRetry(@event.Order, @event.Id)));
        }
